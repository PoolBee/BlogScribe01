...
With the modelscope package, you can use the model like this: First, you pass your input through the transformer model, then you select the last hidden state of the first token (i.e., [CLS]) as the sentence embedding.
...
tokenizer = AutoTokenizer.from_pretrained('AI-ModelScope/bge-small-zh-v1.5')
model = AutoModel.from_pretrained('AI-ModelScope/bge-small-zh-v1.5')
model.eval()
